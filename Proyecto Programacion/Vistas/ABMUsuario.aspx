                        ...
                        <asp:GridView ID="gvUsuarios" runat="server" AutoGenerateDeleteButton="True" AutoGenerateEditButton="True" Width="734px" AllowPaging="True" AutoGenerateColumns="False" OnRowCancelingEdit="gvUsuarios_RowCancelingEdit" OnRowDeleting="gvUsuarios_RowDeleting" OnRowEditing="gvUsuarios_RowEditing" OnRowUpdating="gvUsuarios_RowUpdating">
                            <Columns>
                                <asp:TemplateField HeaderText="IDUSUARIO">
                                    <EditItemTemplate>
                                        <asp:Label ID="LBL_EDIT_ID" runat="server" Text='<%# Eval("ID_USUARIO_U") %>'></asp:Label>
                                    </EditItemTemplate>
                                    <ItemTemplate>
                                    
                                        <asp:Label ID="LBL_IT_ID" runat="server" Text='<%# Eval("ID_USUARIO_U") %>'></asp:Label>
                                ...
                                <asp:TemplateField HeaderText="NOMBRE">
                                    <EditItemTemplate>
                                        ...
                                        <asp:RequiredFieldValidator ID="RFV_NOM" runat="server" ControlToValidate="TXT_EDIT_NOM" Display="Dynamic">CAMPO VACIO</asp:RequiredFieldValidator>
                                    </EditItemTemplate>
                                    <ItemTemplate>
                                ...
                                <asp:TemplateField HeaderText="APELLIDO">
                                    <EditItemTemplate>
                                        ...
                                        <asp:RequiredFieldValidator ID="RFV_APE" runat="server" ControlToValidate="TXT_EDIT_APE" Display="Dynamic">CAMPO VACIO</asp:RequiredFieldValidator>
                                    </EditItemTemplate>
                                    <ItemTemplate>
                                ...
                                <asp:TemplateField HeaderText="TELEFONO">
                                    <EditItemTemplate>
                                        ...
                                        <asp:RequiredFieldValidator ID="RFV_TEL" runat="server" ControlToValidate="TXT_EDIT_TEL" Display="Dynamic">CAMPO VACIO</asp:RequiredFieldValidator>
                                    </EditItemTemplate>
                                    <ItemTemplate>
                                ...
                                <asp:TemplateField HeaderText="CONTRASEÑA">
                                    <EditItemTemplate>
                                        ...
                                        <asp:RequiredFieldValidator ID="RFV_CON" runat="server" ControlToValidate="TXT_EDIT_CON" Display="Dynamic">CAMPO VACIO</asp:RequiredFieldValidator>
                                    </EditItemTemplate>
                                    <ItemTemplate>
                                ...
                                <asp:TemplateField HeaderText="TIPOUSUARIO">
                                    <EditItemTemplate>
                                        <asp:CheckBox ID="CHK_EDIT_SuperUsu" runat="server" Checked='<%# Bind("Tipo_Usuario_U") %>' />
                                    </EditItemTemplate>
                                    <ItemTemplate>
