...
&nbsp;&nbsp;&nbsp;
            ...
            <table class="auto-style1">
                <tr>
                    ...
                    <td>
                        <asp:GridView ID="gvUsuarios" runat="server" AutoGenerateDeleteButton="True" Width="734px" AllowPaging="True" AutoGenerateColumns="False"  OnRowDeleting="gvUsuarios_RowDeleting"  OnPageIndexChanging="gvUsuarios_PageIndexChanging">
                            <Columns>
            ...
            <table class="auto-style1">
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <asp:RegularExpressionValidator ID="RevEmail" runat="server" ControlToValidate="txtEmail" ErrorMessage="\w+([-+.']\w+)*@\w+([-.]\w+)*\.\w+([-.]\w+)*" ValidationGroup="Grupo1">Email invalido</asp:RegularExpressionValidator>
                    </td>
                </tr>
                <tr>
