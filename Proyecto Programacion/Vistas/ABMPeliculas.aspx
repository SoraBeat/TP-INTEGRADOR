        ...
        <div>
            ...
            <nav class="auto-style22" style="background-color: #10179B; padding: 10px 0; display: flex; flex-direction: row; justify-content: space-between; align-items: center;">
                ...
                <div style="display: flex; flex-direction: row; align-items: center; margin-right: 20px">
                    ...
                    </asp:HyperLink></div></nav><div>
                <h1 style="text-align: center; background-color: #343434; padding: 10px 0; color: white; font-weight: 700;">PELICULAS</h1></div><table class="auto-style1">
                <tr class="auto-style1">
                    <td>
                        <asp:DropDownList ID="ddlFiltro" runat="server">
                        </asp:DropDownList>
                        &nbsp;&nbsp;&nbsp;&nbsp; <asp:TextBox ID="tbFiltro" runat="server"></asp:TextBox>&nbsp;&nbsp;&nbsp; <asp:Button class="btn btn-secondary" ID="Button1" runat="server" Text="Filtrar" OnClick="btnFiltrar_Click" />
                        ...
                        <Columns>
                            <asp:TemplateField HeaderText="ID_Pelicula">
                                <EditItemTemplate>
                                    ...
                                    <asp:Label ID="lblIDPelicula" runat="server" Text='<%# Bind("ID") %>'></asp:Label><br /></ItemTemplate></asp:TemplateField><asp:TemplateField HeaderText="Titulo">
                                <EditItemTemplate>
                                    <asp:TextBox ID="TXT_EDT_TITULO" runat="server" Text='<%# Bind("Titulo") %>'></asp:TextBox><asp:RequiredFieldValidator ID="RFV_Titulo" runat="server" ControlToValidate="TXT_EDT_TITULO" ErrorMessage="CAMPO VACIO" ForeColor="Red"></asp:RequiredFieldValidator></EditItemTemplate><ItemTemplate>
                                    <asp:Label ID="lblTituloPeliculas" runat="server" Text='<%# Bind ("Titulo") %>'></asp:Label></ItemTemplate></asp:TemplateField><asp:TemplateField HeaderText="Descripcion">
                                <EditItemTemplate>
                                    <asp:TextBox ID="TXT_EDT_DESCRIPCION" runat="server" Text='<%# Bind("Descripcion") %>'></asp:TextBox><asp:RequiredFieldValidator ID="RFV_Descripcion" runat="server" ControlToValidate="TXT_EDT_DESCRIPCION" ErrorMessage="CAMPO VACIO" ForeColor="Red"></asp:RequiredFieldValidator></EditItemTemplate><ItemTemplate>
                                    <asp:Label ID="lblDescripcionPeliculas" runat="server" Text='<%# Bind ("Descripcion") %>'></asp:Label></ItemTemplate></asp:TemplateField><asp:TemplateField HeaderText="Duracion">
                                <EditItemTemplate>
                                    <asp:TextBox ID="TXT_EDT_DURACION" runat="server" Text='<%# Bind("Duracion") %>'></asp:TextBox><asp:RequiredFieldValidator ID="RFV_Duracion" runat="server" ControlToValidate="TXT_EDT_DURACION" ForeColor="Red">CAMPO VACIO</asp:RequiredFieldValidator></EditItemTemplate><ItemTemplate>
                                    <asp:Label ID="lblDuracionPelicula" runat="server" Text='<%# Bind ("Duracion") %>'></asp:Label></ItemTemplate></asp:TemplateField><asp:TemplateField HeaderText="Clasificacion">
                                <EditItemTemplate>
                                    <asp:TextBox ID="TXT_EDT_CLASIFICACION" runat="server" Text='<%# Bind("Clasificacion") %>'></asp:TextBox><asp:RequiredFieldValidator ID="RFV_Clasificacion" runat="server" ControlToValidate="TXT_EDT_CLASIFICACION" ErrorMessage="RequiredFieldValidator" ForeColor="Red">CAMPO VACIO</asp:RequiredFieldValidator></EditItemTemplate><ItemTemplate>
                                    <asp:Label ID="lblClasificacionPelicula" runat="server" Text='<%# Bind ("Clasificacion") %>'></asp:Label></ItemTemplate></asp:TemplateField><asp:TemplateField HeaderText="Genero">
                                <EditItemTemplate>
                                    <asp:TextBox ID="TXT_EDT_GENERO" runat="server" Text='<%# Bind("Genero") %>'></asp:TextBox><asp:RequiredFieldValidator ID="RFV_Genero" runat="server" ControlToValidate="TXT_EDT_GENERO" ErrorMessage="CAMPO VACIO" ForeColor="Red"></asp:RequiredFieldValidator></EditItemTemplate><ItemTemplate>
                                    <asp:Label ID="lblGeneroPeliculas" runat="server" Text='<%# Bind ("Genero") %>'></asp:Label></ItemTemplate></asp:TemplateField><asp:TemplateField HeaderText="Portada">
                                <EditItemTemplate>
                                    <asp:TextBox ID="TXT_EDT_PORTADA" runat="server" Text='<%# Bind("Portada") %>'></asp:TextBox><asp:RequiredFieldValidator ID="RFV_Portada" runat="server" ControlToValidate="TXT_EDT_PORTADA" ErrorMessage="RequiredFieldValidator" ForeColor="Red">CAMPO VACIO</asp:RequiredFieldValidator></EditItemTemplate><ItemTemplate>
                                    <asp:Label ID="lblPortadaPelicula" runat="server" Text='<%# Bind ("Portada") %>'></asp:Label></ItemTemplate></asp:TemplateField><asp:TemplateField HeaderText="Estado">
                                <EditItemTemplate>
                                    <asp:CheckBox ID="TXT_EDT_ESTADO" runat="server" Checked="True" />
                                </EditItemTemplate>
                                <ItemTemplate>
                                    <asp:Label ID="lblEstadoPelicula" runat="server" Text='<%# Bind ("Estado") %>'></asp:Label></ItemTemplate></asp:TemplateField></Columns><FooterStyle BackColor="#CCCC99" ForeColor="Black" />
            ...
            <div style="width: 100%; display: flex; flex-direction: row;">
                <div class="list-group" style="width: 20%;">
                    ...
                    <asp:HyperLink CssClass="list-group-item" ID="hlComplejoss" runat="server" NavigateUrl="~/ABMComplejo.aspx">Complejos</asp:HyperLink>
                    <asp:HyperLink CssClass="list-group-item" ID="hlSalass" runat="server" NavigateUrl="~/ABMSalas.aspx">Salas</asp:HyperLink>
                    <asp:HyperLink CssClass="list-group-item" ID="hlPeliculass" runat="server" NavigateUrl="~/ABMPeliculas.aspx">Peliculas</asp:HyperLink>
                    <asp:HyperLink CssClass="list-group-item" ID="hlFuncioness" runat="server" NavigateUrl="~/ABMFunciones.aspx">Funciones</asp:HyperLink>
                    <asp:HyperLink CssClass="list-group-item" ID="hlAsientoss" runat="server" NavigateUrl="~/ABMAsientos.aspx">Asientos</asp:HyperLink>
                    <asp:HyperLink CssClass="list-group-item" ID="hlAsientosCompradoss" runat="server" NavigateUrl="~/ABMAsientosComprados.aspx">Asientos Comprados</asp:HyperLink>
                    <asp:HyperLink CssClass="list-group-item" ID="hlVentass" runat="server" NavigateUrl="~/Ventas.aspx">Ventas</asp:HyperLink>
                    <asp:HyperLink CssClass="list-group-item" ID="hlDVV" runat="server" NavigateUrl="~/ABMDetalleVentas.aspx">Detalle de Ventas</asp:HyperLink>
                    <asp:HyperLink CssClass="list-group-item" ID="hlUsuarioss" runat="server" NavigateUrl="~/ABMUsuario.aspx">Usuarios</asp:HyperLink>
                </div>
