            ...
            <div style="width: 100%; display: flex; flex-direction: row; justify-content: center;">
                <div style="width: 25%; display: flex; flex-direction: column; gap: 15px; align-items: center; background-color: rgba(0, 0, 0, 0.85); -webkit-box-shadow: 0px 0px 5px 0px rgba(0,0,0,0.75); -moz-box-shadow: 0px 0px 5px 0px rgba(0,0,0,0.75); box-shadow: 0px 0px 5px 0px rgba(0,0,0,0.75); border-radius: 10px; color: white; padding: 20px 20px">
                    ...
                    <div style="display: flex; justify-content: center; flex-direction: row;">
                        ...
                        <asp:RequiredFieldValidator ID="rfvEmail" runat="server" ControlToValidate="txtUsuario" Display="Dynamic" data-bs-trigger="hover focus" data-bs-toggle="popover" data-bs-content="Campo vacio">*</asp:RequiredFieldValidator>
                        <asp:RegularExpressionValidator ID="RevEmail" runat="server" ControlToValidate="txtUsuario" ValidationExpression="\w+([-+.']\w+)*@\w+([-.]\w+)*\.\w+([-.]\w+)*" Display="Dynamic" data-bs-trigger="hover focus" data-bs-toggle="popover" data-bs-content="Email invalido">*</asp:RegularExpressionValidator>
                    </div>
