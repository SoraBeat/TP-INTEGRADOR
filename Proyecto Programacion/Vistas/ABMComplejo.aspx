...
&nbsp;&nbsp;&nbsp;
            ...
            <table class="auto-style1">
                <tr>
                    ...
                    <td>
                        <asp:GridView ID="gvComplejos" runat="server" AutoGenerateDeleteButton="True" AutoGenerateEditButton="True" Width="734px" AutoGenerateColumns="False" OnRowCancelingEdit="gvComplejos_RowCancelingEdit" OnRowDeleting="gvComplejos_RowDeleting" OnRowEditing="gvComplejos_RowEditing" OnRowUpdating="gvComplejos_RowUpdating">
                            <Columns>
                                <asp:TemplateField HeaderText="ID">
                                    <EditItemTemplate>
                                        <asp:TextBox ID="TXT_EDT_ID" runat="server" Text='<%# Bind("ID") %>'></asp:TextBox>
                                        <asp:RequiredFieldValidator ID="RFV_ID" runat="server" ControlToValidate="TXT_EDT_ID" Display="Dynamic">CAMPO VACIO</asp:RequiredFieldValidator>
                                    </EditItemTemplate>
                                    <ItemTemplate>
